...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/roy/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/roy/overlay/themes/"
overlays_path_temp="$ANDROID_BUILD_TOP/overlays_temp"
overlays_zip_name="roy_overlays.zip"
